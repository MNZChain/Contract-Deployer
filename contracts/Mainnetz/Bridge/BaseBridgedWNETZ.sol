    ...
    ContractMetadata
{
     ...
     * @param supply The initial supply of WNETZ tokens, this is then added to the original bridge to prevent malicious actors bridging initially before liquidity is established.
     */
    constructor(
        uint256 supply
    ) ERC20("Wrapped NETZ", "WNETZ") ERC20Permit("Wrapped NETZ") {
